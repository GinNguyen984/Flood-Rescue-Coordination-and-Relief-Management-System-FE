...
const menuByRole = {
  admin: [
    ...
    { label: "Cấu hình tham số", icon: <SettingOutlined />, path: "/admin/settings" },
    { label: "Logs hệ thống", icon: <FileTextOutlined />, path: "/admin/logs" },
    { label: "Phân quyền nâng cao", icon: <SafetyOutlined />, path: "/admin/permissions" },
  ],

  manager: [
    { label: "Tổng quan", icon: <AppstoreOutlined />, path: "/manager", end: true },
    { label: "Phương tiện", icon: <CarOutlined />, path: "/manager/vehicles" },
    { label: "Kho hàng", icon: <InboxOutlined />, path: "/manager/inventory" },
    { label: "Phê duyệt", icon: <CheckSquareOutlined />, path: "/manager/approve" },
  ...
  rescuecoordinator: [
    ...
    { label: "Hoàn thành & báo cáo", icon: <BarChartOutlined />, path: "/coordinator/reports" },
